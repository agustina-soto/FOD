...
procedure existeEmpleado(var arch: archEmpleados; var e: empleado; var existe: boolean); // "e" llega con el nro de empleado a buscar, cuando existe queda en true en "e" queda la info del empleado
var
	num: integer;
begin
    num := e.nroEmpleado;
