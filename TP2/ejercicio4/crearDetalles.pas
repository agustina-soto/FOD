...
procedure generarMinimos(var vSesiones: detalles; var vMin: usuarios_min);
var
	i: integer;
begin
...
var
	...
	vMin: usuarios_min;
begin
	generarMinimos(vSesiones, vMin); // Abre todos los archivos detalle de vSesiones y almacena los minimos de cada detalle en vMin
	rewrite(mae);
...
var
	...
	txt: text;
begin
	assign(mae, 'archivo_maestro_ej4p2'); // /var/log/'archivo_maestro_ej4p2' -->  es una boludes, tengo que tener creadas las acrpetas pero me dijeron que lo cree aca nomas
